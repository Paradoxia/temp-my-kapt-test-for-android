...
import com.example.myapplication.annotation.GreetingGenerator
import com.google.auto.service.AutoService
import com.example.codegen.simplePoet.KotlinClassBuilder
import java.io.File
    ...
    override fun process(
        ...
        roundEnvironment?.getElementsAnnotatedWith(GreetingGenerator::class.java)
            ?.forEach {
                ...
                val x = it.enclosedElements[0] // fun test()
